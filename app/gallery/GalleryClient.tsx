    ...
    <>
      ...
      <section className="bg-ivory py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* Strategic Cross-Page Navigation */}
          <div className="mt-16 text-center pt-8 border-t border-gold/30">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/events"
                className="inline-flex items-center gap-2 rounded-full bg-marigold px-6 py-2.5 font-bold text-maroon-dark hover:bg-marigold-light transition-all text-sm shadow-md"
              >
                <span>🪔 {t("events")}</span>
                <span>→</span>
              </Link>
              <Link
                href="/about"
                className="inline-flex items-center gap-2 rounded-full border border-gold/50 bg-sandal/40 px-6 py-2.5 font-semibold text-maroon hover:bg-sandal transition-all text-sm"
              >
                <span>📖 {t("about")}</span>
                <span>→</span>
              </Link>
