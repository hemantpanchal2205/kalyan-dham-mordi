...
const homeGalleryImages = [
  {
    ...
    alt: "Kalyan Dham Mordi temple main premises and sanctum",
  },
  {
    id: 2,
    src: "/images/image-36.jpeg",
    alt: "Shri Kali Kalyan Dham Mordi darshan view",
  },
  {
    id: 3,
    src: "/images/image-28.jpeg",
    alt: "Veer Kallaji Rathore worship at Kalyan Dham Mordi",
  },
  {
    id: 4,
    src: "/images/image-29.jpeg",
    alt: "Devotees gathering for Bhav Seva at Kalyan Dham Mordi",
  },
  {
    id: 5,
    src: "/images/image-30.jpeg",
    alt: "Kalyan Dham Mordi sacred Jyot and mandir view",
  },
  {
    id: 6,
    src: "/images/image-10.jpeg",
    alt: "Festival celebrations at Kalyan Dham Mordi",
  },
  {
    id: 7,
    src: "/images/image-17.jpeg",
    alt: "Daily aarti and rituals at Kalyan Dham Mordi",
  },
  {
    id: 8,
    src: "/images/image-37.jpeg",
    alt: "Spiritual atmosphere at Kalyan Dham Mordi Rajasthan",
  },
  {
    id: 9,
    src: "/images/image-16.jpeg",
    alt: "Kalyan Dham Mordi temple entrance and courtyard",
  },
  {
    id: 10,
    src: "/images/image-12.jpeg",
    alt: "Holy darshan moment at Shri Kalyan Dham Mordi",
  },
];
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:py-28 grid lg:grid-cols-2 gap-12 items-center">
          <FadeIn direction="up" duration={500}>
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl text-ivory leading-tight">
              <span className="block text-marigold text-2xl sm:text-3xl lg:text-4xl mb-2 font-normal">
                {t("mandirName")}
              </span>
          ...
          <FadeIn direction="up" delay={200} duration={500}>
            <div className="relative h-72 sm:h-96 lg:h-[26rem] rounded-2xl overflow-hidden border border-marigold/30 shadow-2xl shadow-black/40">
              <Image
                ...
                alt="Shri Kali Kalyan Dham Mordi temple main view - Garhi Partapur Banswara Rajasthan"
                fill
                priority
              ...
              <div className="grid lg:grid-cols-12 gap-8 items-center p-6 sm:p-10 lg:p-12 relative z-10">
                ...
                <div className="lg:col-span-5 relative h-72 sm:h-96 lg:h-[26rem] rounded-2xl overflow-hidden border-2 border-gold/30 shadow-xl">
                  <Image
                    ...
                    alt="Shri Kallaji Rathore Janmotsav annual celebration at Kalyan Dham Mordi"
                    fill
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-stretch">
            ...
            <FadeIn direction="up" delay={200} className="lg:col-span-2 h-full">
              <div className="relative min-h-[380px] h-full rounded-2xl overflow-hidden border border-gold/40 shadow-lg bg-sandal/20">
                <iframe
                  title="Shri Kali Kalyan Dham Mordi Mandir Google Map Location"
